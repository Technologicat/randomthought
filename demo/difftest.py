...
from randomthought.differentiate import prepare, solve_lu, coeffs_full
from randomthought.plotutils import link_3d_subplot_cameras
from randomthought.util import clear_and_create_directory

from .config import difftest_output_dir, fig_format, surfaces_fig_basename, errors_fig_basename
...
def main():
    clear_and_create_directory(difftest_output_dir)
    ...
    with timer() as tim:
        ...
        fig.savefig(f"{difftest_output_dir}{surfaces_fig_basename}.{fig_format}")
        ...
        fig.savefig(f"{difftest_output_dir}{errors_fig_basename}.{fig_format}")
    print(f"    Done in {tim.dt:0.6g}s.")
