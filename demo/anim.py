...
from .config import (vae_output_dir, fig_format,
...
from randomthought.plotter import plot_latent_image, overlay_datapoints
from randomthought.util import preprocess_images
...
for model_filename in input_snapshots:
    ...
    e = plot_latent_image(21, model=main.model, epoch=epoch)
