...
Not very useful in practice, because the convolution loses the edges.
Extrapolating the data in a sensible way turned out to be rather difficult;
usually iterating this and some extrapolation runs into numerical instability,
and the result is not very good.

We nevertheless provide this to document the project history, and in the hope
that this may turn out to be useful elsewhere.
"""
