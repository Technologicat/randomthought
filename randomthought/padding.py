...
Not very useful in practice, because polynomial extrapolation creates new extrema, so enlarging an area
by these methods can trigger a numerical instability e.g. in differentiation of the resulting field.

This is however a missing battery, since TF doesn't provide these operations by default, and sometimes
padding by polynomial extrapolation may be more useful for a full-sized convolution than the standard
options of global constant padding or mirroring at the edge.
"""
